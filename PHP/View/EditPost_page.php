...
<div class="Main">
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 DivMainRight">
        <form method="POST" action="../public/index.php/UpdatePost" id="MakePostForm"
              onsubmit="return confirm('Are you sure you want to update this post?')" enctype="multipart/form-data">
            ...
            <button class="newPost" value="<?php echo $_POST['edit_post'] ?>" name="Save">Save</button>
            <button class="newPost" value="<?php echo $_POST['edit_post'] ?>" name="Publish" style="margin-left:30px;">
                Publish
            </button>
        </form>
    </div>
