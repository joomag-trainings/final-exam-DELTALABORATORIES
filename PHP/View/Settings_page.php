...
<div class="Main">
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 DivMainRight">
        <form method="POST" action="../public/index.php/UpdateAccount" id="MakePostForm"
              onsubmit="return confirm('Are you sure you want to update your Account?')" enctype="multipart/form-data">
